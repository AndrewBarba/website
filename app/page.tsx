import { type Product, Products } from "@/components/products";
		...
		<main className="flex min-h-screen flex-col items-center p-4 pb-20">
			<div className="w-full max-w-4xl">
				...
				<div className="z-10 w-full items-center justify-between text-md lg:flex pb-4">
					<p>
						Coding is a lot like skateboarding - you&apos;ll fall far more often
						than you&apos;ll land.
					</p>
				</div>
				<div className="z-10 w-full items-center space-x-5 text-sm lg:flex underline">
					...
					<a href="https://docs.google.com/document/d/1aHs4peKIfoUQZDuPOnp5W0QB9h24hpUJRjNhKI5hPDE/edit?usp=sharing">
						resume
					</a>
